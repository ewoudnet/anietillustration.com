...
$rows = [
    ['Platform', 'Referentie', 'Shop', 'Datum', 'Totaal', 'Commissie', 'Netto uitbetaald', 'Valuta', 'Status'],
];
...
foreach ($orders as $order) {
    $rows[] = [
        ...
        round(((int) $order['commission_amount_cents']) / 100, 2),
        round(((int) $order['payout_amount_cents']) / 100, 2),
        $order['currency'],
